              ...
              <article key={`${book.id}-highlight`} className="catalog__highlight">
                <Link to={`/book/${book.id}`} className="catalog__highlight-link">
                  ...
                  <div className="catalog__highlight-image">
                    ...
                    {isOutOfStock && (
                      <>
                        <div className="catalog__stock-overlay" aria-hidden="true" />
                        <span className="catalog__stock-badge">{OUT_OF_STOCK_LABEL}</span>
                      </>
                    )}
                  </div>
                ...
                >
                  {isOutOfStock ? OUT_OF_STOCK_LABEL : CTA_LABEL}
                </button>
              </article>
            );
          }
