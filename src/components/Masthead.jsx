...
🚚 При замовленні на суму від 200$
доставка по Канаді — безкоштовна.

🚇 Ми безкоштовно підвозимо ваше
замовлення до однієї з станцій метро:
Berry-UQAM, Viau, Saint-Michel, Beaubien.

Також можемо домовитися про інше
зручне місце в межах Монреаля.

🎁 АКЦІЯ: БЕЗКОШТОВНА ДОСТАВКА!
